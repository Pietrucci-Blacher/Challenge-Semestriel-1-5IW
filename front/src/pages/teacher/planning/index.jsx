    ...
    return (
        <>
            <Breadcrumb aria-label="Default breadcrumb example">
                ...
                <Breadcrumb.Item href="/provider/planning/">
                    Planning
                </Breadcrumb.Item>
            </Breadcrumb>
            <div className="mt-4">
                <div className="my-8">
                    <div className="flex items-center">
                        <h2 className="mr-2">
                            Cette Page affiche le planing de mes differents
                            etablissements
                        </h2>
                    </div>
                        ...
                        {userApprovedInvitation.length > 0 ? (
                            <>
                                <div className="mb-2 block">
                                    <Label
                                        htmlFor="countries"
                                        value="Select votre etablissement"
                                    />
                                </div>
                                <Select
                                    id="countries"
                            ...
                            <div>Vous etes affecté a aucune etablissement</div>
                        )}
                    </div>
                </div>
            </div>
