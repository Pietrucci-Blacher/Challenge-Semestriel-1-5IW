...
export default function TeacherDashboard() {
    ...
    const { teacherReservations, fetchTeacherReservations } = useReservation();
    /*

    useEffect(() => {
        const { id } = user;
        if (!id) return;
        fetchTeacherReservations(id);
    }, [fetchTeacherReservations, user]);
*/
    ...
    return (
        <div className="flex h-full bg-gray-50 dark:bg-gray-900">
            <Head>
                <title>Coursia - Teacher Dashboard</title>
            </Head>
