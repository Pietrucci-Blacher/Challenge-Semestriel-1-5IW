...
export default function Team() {
  ...
  const { addMemberToTeam, reInviteMemberToTeam, removeMemberFromTeam } =
    useTeamMember();
  useEffect(() => {
    getMyEstablishments();
  }, []);
  ...
  return (
    <>
        ...
        <div className="flex flex-row flex-wrap">
          {establishments &&
            establishments.map((establishment) => (
              <TeamCard
                onReinviteMember={onMemberReinvite}
      ...
      <Modal show={showModal} onClose={closeModal} size="sm">
        <Modal.Header>
          Inviter un membre a rajoindre votre etablissement
        </Modal.Header>
        <Modal.Body>
          <form
          ...
          >
            ...
            <div className="">
              <div className="mb-2 block">
                <Label
                  htmlFor="countries"
                  value="Selectionnez une etablissement"
                />
              </div>
              <Select
                id="countries"
