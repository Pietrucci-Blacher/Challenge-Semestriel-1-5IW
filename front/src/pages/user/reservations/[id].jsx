    ...
    return (
        <>
            ...
            <div>
                ...
                <br/>
                <div>
                    Teacher : {reservation?.teacher?.firstname} {reservation?.teacher?.lastname}
                </div>
            </div>
            <br/>
            <div>
            ...
            <Modal show={isCancelModalOpen} onClose={() => setIsCancelModalOpen(false)}>
            ...
            <Modal show={isMoveModalOpen} onClose={() => setIsMoveModalOpen(false)} size="6xl">
                ...
                <Modal.Body>
                    ...
                    <div className="space-y-6">
                        {schedules !== null && (
                            <>
                                <ScheduleSelector range={reservation?.service?.duration} unavailableSlots={schedules}
            ...
            <Modal show={isAppointmentModalOpen} onClose={() => setIsAppointmentModalOpen(false)} size="6xl">
