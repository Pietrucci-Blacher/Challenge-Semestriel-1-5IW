...
export const ToastProvider = ({ children }) => {
  ...
  const listOfClasses = {
    ...
    warning:
      "inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-orange-100 text-orange-500 dark:bg-orange-700 dark:text-orange-200",
    message: "",
    refresh:
      "inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-cyan-100 text-cyan-500 dark:bg-cyan-900 dark:text-cyan-300",
    default:
  ...
  const Icon = listOfIcons.hasOwnProperty(toastProps.type)
    ? listOfIcons[toastProps.type]
    : listOfIcons["default"];
  const classForIcon = listOfClasses.hasOwnProperty(toastProps.type)
    ? listOfClasses[toastProps.type]
    : listOfClasses["default"];
